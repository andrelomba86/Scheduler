...
export const SHOW_NAMES_AND_ADD_DATES_PROMPT = SHOW_NAMES | SHOW_ADD_DATES_PROMPT | SHOW_CALENDAR
export const SHOW_NAMES_AND_EDIT_DATES_PROMPT = SHOW_NAMES | SHOW_EDIT_DATES_PROMPT | SHOW_CALENDAR
export const SHOW_NAMES_AND_REMOVE_DATES_PROMPT = SHOW_NAMES | SHOW_DATES | SHOW_REMOVE_DATES_PROMPT | SHOW_CALENDAR
